...
##Step 1
##The  code for reading  the dataset and processing of the data
```{r, echo = TRUE}
...
##Step 6
The followin is the code to describe and to show a strategy for imputing missing data.
...
## Step 8
PThe panel plot comparing the average number of steps taken per 5-minute interval across weekdays and weekends
